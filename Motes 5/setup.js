...
async function Start(key, param) {
	if (key == 1) {
		...
		Output("");
		Print([
			["<span class=\"mono\">Though no such content exists at present, this game is planned to cover very adult themes, including sexually explicit material. In order to continue, you must verify that you are at least 18 years old, and that it is legal for you to view such content wherever you are located.</span>"],
			["execute", function() {
		...
		document.getElementById("colorsheet").setAttribute("href", "desert.css");
		...
		document.getElementById("inverter").style.opacity = 0;
		await timer(750);
