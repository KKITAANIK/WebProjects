...
function Styling() {
    ...
    let topbarColors = ["#fadadd", "#e5b365", "#726581", "#1f2933", "#0e1111"];
    let textColors = ["#dec2c4", "#b78f50", "#8e7ea1", "#2e3d4c", "#151919"];
    let buttonColors = ["#c5acae", "#927240", "#b19dc9", "#394c5f", "#1f2525"];
